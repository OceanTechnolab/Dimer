...
const SolarArea = () => {
  ...
  const features = [
    "Specialty chemicals for solar cell and photovoltaic research.",
    "High purity and performance for energy applications.",
    "Suitable for organic, inorganic, and hybrid solar technologies.",
  ...
  const fetchProducts = async () => {
    ...
    formData.append("category", "Solar Chemicals");
            ...
            <div className="col-lg-6 col-md-6">
              ...
              >
                <div className="product__details-content mb-40">
                  <h5 className="product-dtitle mb-30">SOLAR CHEMICALS</h5>
                  <p className="pd-description">
                    Our solar chemicals are designed for use in photovoltaic and solar cell research. We offer high-purity materials for organic, inorganic, and hybrid solar technologies, supporting innovation in renewable energy.
                  </p>
