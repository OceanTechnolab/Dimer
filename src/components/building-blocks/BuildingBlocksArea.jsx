...
const BuildingBlocksArea = () => {
  const [productData, setProductData] = useState([]);
  const [loading, setLoading] = useState(true);

  const features = [
    "Wide range of chemical building blocks for synthesis.",
    "High purity and consistent quality.",
    "Suitable for pharmaceutical, agrochemical, and material science research.",
    "Available in various pack sizes and grades."
  ];
            ...
            <div className="col-lg-6 col-md-6">
              ...
              >
                <div className="product__details-content mb-40">
                  <h5 className="product-dtitle mb-30">BUILDING BLOCKS</h5>
                  <p className="pd-description">
                    Our chemical building blocks are essential for organic synthesis and research in pharmaceuticals, agrochemicals, and materials science. We offer a wide range of high-purity compounds to support your innovation.
                  </p>
...
export default BuildingBlocksArea; 