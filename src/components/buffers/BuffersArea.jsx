...
const BuffersArea = () => {
  ...
  const features = [
    "High-purity biological buffers for life science research.",
    "Stable pH and minimal contaminants.",
    "Suitable for molecular biology, biochemistry, and cell culture.",
    "Available in various concentrations and pack sizes."
  ];
  ...
  const fetchProducts = async () => {
    ...
    formData.append("category", "Biological Buffers");
            ...
            <div className="col-lg-6 col-md-6">
              ...
              >
                <div className="product__details-content mb-40">
                  <h5 className="product-dtitle mb-30">BIOLOGICAL BUFFERS</h5>
                  <p className="pd-description">
                    Our biological buffers are manufactured to the highest standards for use in life science research, molecular biology, and cell culture. They provide stable pH and minimal contaminants for reliable experimental results.
                  </p>
